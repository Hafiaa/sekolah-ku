              ...
              <div class="card-body">
                <table class="table-bordered table table-striped">
                 ...
                 <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="<?= base_url('admin/biaya_lain/delete/').md5($key->id_siswa).'/'.md5($key->id_siswa_biaya_lain).'?nis='.$_GET['nis'] ?>" onclick="return confirm('Yakin mau hapus data biaya lain <?= $key->nama_biaya_lain ?> Rp. <?= number_format($key->jumlah_biaya_lain - (($key->jumlah_biaya_lain * $key->persen_biaya_lain) / 100), 0, ',', '.') ?>,-')"><i class="fa fa-trash fa-2x text-danger"></i></a>
                    </td>
                    <td class="text-center">
                    <a href="<?= base_url('admin/biaya_lain/bayar_biaya_lain/').md5($key->id_siswa).'/'.md5($key->id_siswa_biaya_lain).'?nis='.$_GET['nis'] ?>" class="btn bg-gradient-warning text-white btn-circle btn-sm"><i class="fa fa-edit"></i></a> 
                    </td>
                  </tr>
                  <?php
                 ...
                 <tfoot class="bg-gray-900 text-white">
                   <tr>
                     <?= form_open('admin/biaya_lain/add?nis='.$_GET['nis']) ?>
                     <td colspan="7">

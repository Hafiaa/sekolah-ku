		...
		<div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="nama_biaya_lain" class="form-control" value="<?= set_value('nama_biaya_lain') ? set_value('nama_biaya_lain') : $biaya_lain->nama_biaya_lain ?>">
                <small class="text-danger"><?= form_error('nama_biaya_lain') ?></small>
              </div>
              <div class="form-group">
                <small for="harga_biaya_lain">Harga : </small>
                <input type="number" name="harga_biaya_lain" class="form-control" value="<?= set_value('harga_biaya_lain') ? set_value('harga_biaya_lain') : $biaya_lain->harga_biaya_lain ?>">

            ...
            <?php if (@$pengeluaran): ?>
              ...
              <div class="row" style="margin-top: 20px; display: none;" id="data-pengeluaran">
                ...
                <div class="col-lg-12"><br>
                  <a href="<?= base_url('admin/laporan/print_pengeluaran/').$_POST['tanggal1'].'/'.$_POST['tanggal2'] ?>" class="btn btn-default btn-xs pull-right bg-gray-500 text-white" target="_blank"><i class="fas fa-print"></i> Print</a>
                  <br><br>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="alert alert-danger alert-message" data-dismiss="alert" style="display: none;">
                  Laporan pengeluaran pada tanggal <b><?= $this->lib->date_indo($_POST['tanggal1']).' - '.$this->lib->date_indo($_POST['tanggal2']) ?></b> tidak ditemukan !
                </div>
              </div>
            </div>
            <script>

		...
		<div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="nama_jurusan" class="form-control" value="<?= set_value('nama_jurusan') ? set_value('nama_jurusan') : $jurusan->nama_jurusan  ?>">
                <small class="text-danger"><?= form_error('nama_jurusan') ?></small>
              </div>
               <div class="form-group">
                <small for="harga_spp">Harga Spp / Bulan : </small>
                <input type="number" name="harga_spp" class="form-control" value="<?= set_value('harga_spp') ? set_value('harga_spp') : $jurusan->harga_spp ?>">

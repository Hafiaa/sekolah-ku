		...
		<div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="number" name="jumlah_pengeluaran" class="form-control" value="<?= set_value('jumlah_pengeluaran') ? set_value('jumlah_pengeluaran') : $pengeluaran->jumlah_pengeluaran ?>">
                <small class="text-danger"><?= form_error('jumlah_pengeluaran') ?></small>
              </div>

              <div class="form-group">
                <small for="keterangan_pengeluaran">Keterangan Pengeluaran : </small>
                <textarea name="keterangan_pengeluaran" class="form-control" rows="10"><?= set_value('keterangan_pengeluaran') ? set_value('keterangan_pengeluaran') : $pengeluaran->keterangan_pengeluaran ?></textarea>

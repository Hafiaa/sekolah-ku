...
<?php if (@$broadcast): ?>
  <div class="alert alert-warning">
    <i class="fa fa-bullhorn"></i> <b>Pengumuman</b> <br><?= @$broadcast ?>
  </div>
<?php endif ?>
  <div class="abt-title mb-70 text-center">
      <h2><i class="fa fa-user"></i> Pencarian Siswa</h2>
  </div>
	<div class="row">
		<div class="col-lg-12">
			<?= form_open('') ?>
          ...
          <div class="box-search">
              <input class="form-control" placeholder="Cari siswa berdasarkan NIS" name="nisn" id="nisn" type="number" value="<?= set_value('nisn') ?>" autofocus >
          </div>
      </div><br>
        
    <?php if (@$error): ?>
      <div class="alert alert-danger">
        <i class="fa fa-warning"></i> <?= $pesan ?>
      </div>
    <?php endif ?>
	...
	<div class="row">
          <div class="col-lg-12">
            <div class="card shadow mb-4">
              <div class="card-header py-3" style="background: #212121;">
         ...
         <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card shadow mb-4">
              <div class="card-header py-3" style="background: #222;">
                <h6 class="m-0 font-weight-bold text-white">Biaya Lain-lain</h6>
              </div>
              <div class="card-body bg-gray-800">
